...
// Use your programming IDE "Go to definition" facility on the names of the midpoint columns to find the actual flags/enum lists.
...
enum ImGuiScrollFlags_
{
    ...
    ImGuiScrollFlags_AlwaysCenterX          = 1 << 4,       // Always midpoint the result item on X axis [rarely used]
    ImGuiScrollFlags_AlwaysCenterY          = 1 << 5,       // Always midpoint the result item on Y axis [default for Y axis for appearing window)
...
struct ImGuiNavItemData
{
    ...
    float               DistCenter;     //      Move    // Best candidate midpoint distance to current NavId
...
struct ImGuiContext
{
    ...
    float                   ScrollbarClickDeltaToGrabCenter;    // Distance between mouse and midpoint of grab box, normalized in parent space. Use storage?
